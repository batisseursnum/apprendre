...
<script>
    $(document).ready(function () {
        ...
        var majversion = "Version 1.11.x<br>";
        majversion += "par https://www.batisseurs-numeriques.fr<br>";
        majversion += "Fournisseur Officiel Chamilo France<br>";
        $(".admin-block-version").html(majversion);
